...
<head>
    ...
    <title>Teachers Details - Student Management System</title>
    ...
    <div class="mainbody">
        ...
        <div class="dashboard_contents ">
            <div class="text_content">
                <p class="textC">Teachers Details</p>
            </div>
            <a href="addteachers.php"><button class="addstudents">Add Teachers</button></a>
