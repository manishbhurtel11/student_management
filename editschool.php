...
<head>
    ...
    <title>Edit the School Details - Student Management System</title>
            ...
            <div class="main main2">
                <form action="edit.php" class="detailsform">
                    ...
                    <div class="username_section">
                        <label for="name" class="labels">School Name</label>
                        <input type="text" name="name" class="name">
                    </div>
                    <div class="email_section">
                        <label for="email" class="labels">School E-Mail</label>
                        <input type="email" name="email" class="email">
                    </div>
                    <div class="address_section">
                        <label for="address" class="labels">School Address</label>
                        <input type="text" name="address" class="address">
                    </div>
                    <div class="phone_section">
                        <label for="number" class="labels">School Public Number</label>
